...
- Delegating Parts of The Report
  - Parts 1 - 3 (introduction, table of data): 
...
-Alex's ideas for project
  ...
  -seek ideas on Christian's previous ideas on the dataset if had any 
  -try to discuss explicitly the methods(diagonistics, bootstraps) each one would probably use
  -plan to ask Armin tomorrow on what to be covered in proposal presentation, how long it would be for each group, guess maybe not too much analysis required rn
